...
class LoadBalanceGraphDataset(torch.utils.data.IterableDataset):
    ...
    def __getitem__(self, idx):
        ...
        if self.aug == "rwr":
            ...
            # print(trace1,trace2)            
            # print( dgl.sampling.random_walk(
            #     self.graphs[graph_idx],
            #     nodes=[3],
            #     restart_prob=.9999,
            #     length=10,
            ...
            #     length=10,
            # )[0])
            # print(rwr.rwr_for_one_node(
            #     self.graphs[graph_idx],
            #     nodes=[3],
            #     restart_prob=.8,
            #     length=254,
            # ))
            # print(node_idx,self.graphs[graph_idx].successors(node_idx)[0])
            # print(self.graphs[graph_idx].has_edges_between(node_idx,self.graphs[graph_idx].successors(node_idx)[0]))
            # print(self.graphs[graph_idx].has_edges_between(self.graphs[graph_idx].successors(node_idx)[0],node_idx))
            # print(self.graphs[graph_idx].is_homogeneous)
            # print([node_idx, other_node_idx])
            # print(self.graphs[graph_idx].successors(node_idx))
            # print(self.graphs[graph_idx])
            # print(max_nodes_per_seed)
            # print(int(
            #         (
            #             (self.graphs[graph_idx].in_degrees(node_idx) ** 0.75)
            #             * math.e
            ...
            # print(self.graphs[graph_idx].in_degrees(node_idx))
            # print(traces[0])
            # print('hello hello hello help help')
